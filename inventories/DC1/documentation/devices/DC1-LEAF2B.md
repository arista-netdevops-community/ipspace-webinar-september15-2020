...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.200.107/24 | 192.168.200.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 172.31.251.17/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | routed | - | 172.31.251.19/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE3_Ethernet3 | routed | - | 172.31.251.21/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE4_Ethernet3 | routed | - | 172.31.251.23/31 | default | 1500 | false | - | - |
...
| 172.31.251.16 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.18 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.20 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.22 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65102
   ...
   neighbor 172.31.251.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.16 remote-as 65100
   neighbor 172.31.251.16 description DC1-SPINE1_Ethernet3
   neighbor 172.31.251.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.18 remote-as 65100
   neighbor 172.31.251.18 description DC1-SPINE2_Ethernet3
   neighbor 172.31.251.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.20 remote-as 65100
   neighbor 172.31.251.20 description DC1-SPINE3_Ethernet3
   neighbor 172.31.251.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.22 remote-as 65100
   neighbor 172.31.251.22 description DC1-SPINE4_Ethernet3

...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet2  |  routed  | - |  172.30.252.9/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet2  |  routed  | - |  172.30.252.11/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet2  |  routed  | - |  172.30.252.13/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet2  |  routed  | - |  172.30.252.15/31  |  default  |  1500  |  false  |  -  |  -  |
...
interface Ethernet1
   ...
   no shutdown
   no switchport
   ip address 172.30.252.9/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet2
   no shutdown
   no switchport
   ip address 172.30.252.11/31
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SPINE3_Ethernet2
   no shutdown
   no switchport
   ip address 172.30.252.13/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-SPINE4_Ethernet2
   no shutdown
   no switchport
   ip address 172.30.252.15/31
!
interface Ethernet5
...
| 172.30.252.8 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.10 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.12 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.14 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.251.6:10110 |  10110:10110 |  -  | -  | learned |
| 111 | 192.168.251.6:10111 |  10111:10111 |  -  | -  | learned |
| 120 | 192.168.251.6:10120 |  10120:10120 |  -  | -  | learned |
| 121 | 192.168.251.6:10121 |  10121:10121 |  -  | -  | learned |
| 130 | 192.168.251.6:10130 |  10130:10130 |  -  | -  | learned |
| 131 | 192.168.251.6:10131 |  10131:10131 |  -  | -  | learned |
| 160 | 192.168.251.6:10160 |  10160:10160 |  -  | -  | learned |
...
router bgp 65102
   ...
   neighbor 172.30.252.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.14 peer group IPv4-UNDERLAY-PEERS
   ...
   !
   vlan 110
      rd 192.168.251.6:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 192.168.251.6:10111
      route-target both 10111:10111
      redistribute learned
   !
   vlan 120
      rd 192.168.251.6:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 121
      rd 192.168.251.6:10121
      route-target both 10121:10121
      redistribute learned
   !
   vlan 130
      rd 192.168.251.6:10130
      route-target both 10130:10130
      redistribute learned
   !
   vlan 131
      rd 192.168.251.6:10131

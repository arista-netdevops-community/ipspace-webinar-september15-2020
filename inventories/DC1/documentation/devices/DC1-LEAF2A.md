...
| Ethernet7 | DC1-L2LEAF1A_Ethernet1 | *trunk | *110,120-121 | *- | *- | 7 |
...
| Port-Channel7 | DC1_L2LEAF1_Po1 | switched | trunk | 110,120-121 | - | - | - | - | 7 | - |
...
interface Port-Channel7
   ...
   no shutdown
   switchport
   switchport trunk allowed vlan 110,120-121
   switchport mode trunk
   mlag 7
!
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.251.6:10 |  10:10  |  |  | learned | 110 |

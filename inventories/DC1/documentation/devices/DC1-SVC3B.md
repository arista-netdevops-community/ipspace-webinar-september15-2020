...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet5  |  routed  | - |  172.31.252.33/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet5  |  routed  | - |  172.31.252.35/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet5  |  routed  | - |  172.31.252.37/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet5  |  routed  | - |  172.31.252.39/31  |  default  |  1500  |  false  |  -  |  -  |
...
interface Ethernet1
   ...
   no shutdown
   no switchport
   ip address 172.31.252.33/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet5
   no shutdown
   no switchport
   ip address 172.31.252.35/31
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SPINE3_Ethernet5
   no shutdown
   no switchport
   ip address 172.31.252.37/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-SPINE4_Ethernet5
   no shutdown
   no switchport
   ip address 172.31.252.39/31
!
interface Ethernet5
...
| 172.31.252.32 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.34 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.36 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.38 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65103
   ...
   neighbor 172.31.252.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.38 peer group IPv4-UNDERLAY-PEERS

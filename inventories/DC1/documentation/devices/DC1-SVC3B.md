...
| Ethernet7 | DC1-L2LEAF2A_Ethernet2 | *trunk | *110-111,120-121,130-131,160 | *- | *- | 7 |
| Ethernet8 | DC1-L2LEAF2B_Ethernet2 | *trunk | *110-111,120-121,130-131,160 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet5  |  routed  | - |  172.30.252.33/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet5  |  routed  | - |  172.30.252.35/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet5  |  routed  | - |  172.30.252.37/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet5  |  routed  | - |  172.30.252.39/31  |  default  |  1500  |  false  |  -  |  -  |
...
interface Ethernet1
   ...
   no shutdown
   no switchport
   ip address 172.30.252.33/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet5
   no shutdown
   no switchport
   ip address 172.30.252.35/31
!
interface Ethernet3
   description P2P_LINK_TO_DC1-SPINE3_Ethernet5
   no shutdown
   no switchport
   ip address 172.30.252.37/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-SPINE4_Ethernet5
   no shutdown
   no switchport
   ip address 172.30.252.39/31
!
interface Ethernet5
...
| Port-Channel7 | DC1_L2LEAF2_Po1 | switched | trunk | 110-111,120-121,130-131,160 | - | - | - | - | 7 | - |
...
| 172.30.252.32 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.34 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.36 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.38 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.251.9:10110 |  10110:10110 |  -  | -  | learned |
| 111 | 192.168.251.9:10111 |  10111:10111 |  -  | -  | learned |
| 120 | 192.168.251.9:10120 |  10120:10120 |  -  | -  | learned |
| 121 | 192.168.251.9:10121 |  10121:10121 |  -  | -  | learned |
| 130 | 192.168.251.9:10130 |  10130:10130 |  -  | -  | learned |
| 131 | 192.168.251.9:10131 |  10131:10131 |  -  | -  | learned |
| 160 | 192.168.251.9:10160 |  10160:10160 |  -  | -  | learned |
...
router bgp 65103
   ...
   neighbor 172.30.252.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.38 peer group IPv4-UNDERLAY-PEERS
   ...
   !
   vlan 110
      rd 192.168.251.9:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 192.168.251.9:10111
      route-target both 10111:10111
      redistribute learned
   !
   vlan 120
      rd 192.168.251.9:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 121
      rd 192.168.251.9:10121
      route-target both 10121:10121
      redistribute learned
   !
   vlan 130
      rd 192.168.251.9:10130
      route-target both 10130:10130
      redistribute learned
   !
   vlan 131
      rd 192.168.251.9:10131

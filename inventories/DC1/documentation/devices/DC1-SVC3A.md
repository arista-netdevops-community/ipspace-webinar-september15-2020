...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.200.108/24 | 192.168.200.1 |
...
| Ethernet7 | DC1-L2LEAF2A_Ethernet1 | *trunk | *110-111,120-121,130-131,160-161 | *- | *- | 7 |
| Ethernet8 | DC1-L2LEAF2B_Ethernet1 | *trunk | *110-111,120-121,130-131,160-161 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 172.31.251.25/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 172.31.251.27/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE3_Ethernet4 | routed | - | 172.31.251.29/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE4_Ethernet4 | routed | - | 172.31.251.31/31 | default | 1500 | false | - | - |
...
| 172.31.251.24 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.26 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.28 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.31.251.30 | 65100 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_APP_Zone | 192.168.251.8:12 | 12:12 | - | - | learned | 130-131 |
...
router bgp 65103
   ...
   neighbor 172.31.251.24 remote-as 65100
   neighbor 172.31.251.24 description DC1-SPINE1_Ethernet4
   neighbor 172.31.251.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.26 remote-as 65100
   neighbor 172.31.251.26 description DC1-SPINE2_Ethernet4
   neighbor 172.31.251.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.28 remote-as 65100
   neighbor 172.31.251.28 description DC1-SPINE3_Ethernet4
   neighbor 172.31.251.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.251.30 remote-as 65100
   neighbor 172.31.251.30 description DC1-SPINE4_Ethernet4

...
| Ethernet7 | DC1-L2LEAF2A_Ethernet1 | *trunk | *110-111,120-121,130-131,160 | *- | *- | 7 |
| Ethernet8 | DC1-L2LEAF2B_Ethernet1 | *trunk | *110-111,120-121,130-131,160 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet4  |  routed  | - |  172.30.252.25/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet4  |  routed  | - |  172.30.252.27/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet4  |  routed  | - |  172.30.252.29/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet4  |  routed  | - |  172.30.252.31/31  |  default  |  1500  |  false  |  -  |  -  |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.251.8/32 |
...
| 172.30.252.24 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.26 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.28 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.30.252.30 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.251.8:10110 |  10110:10110 |  -  | -  | learned |
| 111 | 192.168.251.8:10111 |  10111:10111 |  -  | -  | learned |
| 120 | 192.168.251.8:10120 |  10120:10120 |  -  | -  | learned |
| 121 | 192.168.251.8:10121 |  10121:10121 |  -  | -  | learned |
| 130 | 192.168.251.8:10130 |  10130:10130 |  -  | -  | learned |
| 131 | 192.168.251.8:10131 |  10131:10131 |  -  | -  | learned |
| 160 | 192.168.251.8:10160 |  10160:10160 |  -  | -  | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_APP_Zone | 192.168.251.8:12 | connected |
...
router bgp 65103
   ...
   neighbor 172.30.252.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.30.252.30 peer group IPv4-UNDERLAY-PEERS
   ...
   !
   vlan 110
      rd 192.168.251.8:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 111
      rd 192.168.251.8:10111
      route-target both 10111:10111
      redistribute learned
   !
   vlan 120
      rd 192.168.251.8:10120
      route-target both 10120:10120
      redistribute learned
   !
   vlan 121
      rd 192.168.251.8:10121
      route-target both 10121:10121
      redistribute learned
   !
   vlan 130
      rd 192.168.251.8:10130
      route-target both 10130:10130
      redistribute learned
   !
   vlan 131
      rd 192.168.251.8:10131

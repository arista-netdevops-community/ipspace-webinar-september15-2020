...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet4  |  routed  | - |  172.31.252.25/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet4  |  routed  | - |  172.31.252.27/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC1-SPINE3_Ethernet4  |  routed  | - |  172.31.252.29/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC1-SPINE4_Ethernet4  |  routed  | - |  172.31.252.31/31  |  default  |  1500  |  false  |  -  |  -  |
...
interface Ethernet1
   ...
   no shutdown
   no switchport
   ip address 172.31.252.25/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet4
   no shutdown
   no switchport
   ip address 172.31.252.27/31
!
interface Ethernet3
...
| 172.31.252.24 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.26 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.28 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.30 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65103
   ...
   neighbor 172.31.252.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.30 peer group IPv4-UNDERLAY-PEERS

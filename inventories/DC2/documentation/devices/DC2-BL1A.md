...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC2-BL1B_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_DC2-BL1B_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC2-SPINE1_Ethernet3  |  routed  | - |  172.31.252.9/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC2-SPINE2_Ethernet3  |  routed  | - |  172.31.252.11/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet10 |  P2P_LINK_TO_DC1-BL1A_Ethernet10  |  routed  | - |  172.31.0.1/31  |  default  |  1500  |  -  |  -  |  -  |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC2-BL1B_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.253.5/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  10.255.253.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.254.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.255.253.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
| 172.31.0.0 | Inherited from peer group DCI-IPv4-UNDERLAY-PEERS | default |
| 172.31.252.8 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.10 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 192.168.251.10 | Inherited from peer group DCI-EVPN-OVERLAY-PEERS | default |

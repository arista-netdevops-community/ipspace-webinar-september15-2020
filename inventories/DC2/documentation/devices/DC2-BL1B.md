...
| --------- | --------------- | ------------ | --------- |
| DC2_BL1 | Vlan4094 | 10.255.254.4 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC2-BL1A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_DC2-BL1A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC2-SPINE1_Ethernet4  |  routed  | - |  172.31.252.13/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC2-SPINE2_Ethernet4  |  routed  | - |  172.31.252.15/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet10 |  P2P_LINK_TO_DC1-BL1B_Ethernet10  |  routed  | - |  172.31.0.3/31  |  default  |  1500  |  -  |  -  |  -  |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL1A_Ethernet3
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC2-BL1A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-BL1A_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.253.6/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  10.255.253.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.254.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.255.253.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
| 172.31.0.2 | Inherited from peer group DCI-IPv4-UNDERLAY-PEERS | default |
| 172.31.252.12 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.252.14 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 192.168.251.11 | Inherited from peer group DCI-EVPN-OVERLAY-PEERS | default |
...
router bgp 65202
   ...
   neighbor 172.31.0.2 peer group DCI-IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.251.11 peer group DCI-EVPN-OVERLAY-PEERS

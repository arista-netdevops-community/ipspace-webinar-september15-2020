...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC2-LEAF1A_Ethernet1  |  routed  | - |  172.31.252.0/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC2-LEAF1B_Ethernet1  |  routed  | - |  172.31.252.4/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet3 |  P2P_LINK_TO_DC2-BL1A_Ethernet1  |  routed  | - |  172.31.252.8/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_DC2-BL1B_Ethernet1  |  routed  | - |  172.31.252.12/31  |  default  |  1500  |  false  |  -  |  -  |
...
!
interface Ethernet3
   description P2P_LINK_TO_DC2-BL1A_Ethernet1
   no shutdown
   no switchport
   ip address 172.31.252.8/31
!
interface Ethernet4
   description P2P_LINK_TO_DC2-BL1B_Ethernet1
   no shutdown
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.253.1/32 |
...
| -------- | --------- | --- |
| 172.31.252.1 | 65201 | default |
| 172.31.252.5 | 65201 | default |
| 172.31.252.9 | 65202 | default |
| 172.31.252.13 | 65202 | default |
...
router bgp 65200
   ...
   neighbor 172.31.252.9 remote-as 65202
   neighbor 172.31.252.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.252.13 remote-as 65202

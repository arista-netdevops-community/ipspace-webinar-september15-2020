...
| --- | ----------- | ------------ | ------------ | ----------------- |
| DC2-BL1A |  35 | 34 | 1 | Interface State |
| DC2-BL1B |  35 | 34 | 1 | Interface State |
| DC2-L2LEAF1A |  7 | 7 | 0 | - |
| DC2-LEAF1A |  50 | 50 | 0 | - |
| DC2-LEAF1B |  50 | 50 | 0 | - |
| DC2-SPINE1 |  31 | 31 | 0 | - |
...
| 94 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet1 - remote: DC2-SPINE1_Ethernet3 | PASS |  |
| 95 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: DC2-SPINE2_Ethernet3 | PASS |  |
| 96 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet3 - remote: DC2-BL1B_Ethernet3 | PASS |  |
| 97 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet4 - remote: DC2-BL1B_Ethernet4 | PASS |  |
...
| 100 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet3 - remote: DC2-BL1A_Ethernet3 | PASS |  |
| 101 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet4 - remote: DC2-BL1A_Ethernet4 | PASS |  |
...
| 109 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet1 - remote: DC2-SPINE1_Ethernet2 | PASS |  |
| 110 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: DC2-SPINE2_Ethernet2 | PASS |  |
...
| 114 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet3 - remote: DC2-BL1A_Ethernet1 | PASS |  |
...
| 117 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: DC2-LEAF1B_Ethernet1 | PASS |  |
...
| 121 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: DC2-LEAF1B_Ethernet2 | PASS |  |
| 122 | DC2-BL1A | MLAG | MLAG State active & Status connected | MLAG | PASS |  |
| 123 | DC2-BL1B | MLAG | MLAG State active & Status connected | MLAG | PASS |  |
...
| 128 | DC2-LEAF1B | IP Reachability | ip reachability test p2p links | Source: DC2-LEAF1B_Ethernet1 - Destination: DC2-SPINE1_Ethernet2 | PASS |  |
| 129 | DC2-LEAF1B | IP Reachability | ip reachability test p2p links | Source: DC2-LEAF1B_Ethernet2 - Destination: DC2-SPINE2_Ethernet2 | PASS |  |
| 130 | DC2-SPINE1 | IP Reachability | ip reachability test p2p links | Source: DC2-SPINE1_Ethernet3 - Destination: DC2-BL1A_Ethernet1 | PASS |  |
...
| 133 | DC2-SPINE1 | IP Reachability | ip reachability test p2p links | Source: DC2-SPINE1_Ethernet2 - Destination: DC2-LEAF1B_Ethernet1 | PASS |  |
...
| 137 | DC2-SPINE2 | IP Reachability | ip reachability test p2p links | Source: DC2-SPINE2_Ethernet2 - Destination: DC2-LEAF1B_Ethernet2 | PASS |  |
...
| 144 | DC2-BL1A | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.5 | PASS |  |
...
| 147 | DC2-BL1A | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.8 | PASS |  |
| 148 | DC2-BL1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.4 | PASS |  |
...
| 155 | DC2-LEAF1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.4 | PASS |  |
| 156 | DC2-LEAF1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.6 | PASS |  |
| 157 | DC2-LEAF1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.0 | PASS |  |
| 158 | DC2-SPINE1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.9 | PASS |  |
...
| 161 | DC2-SPINE1 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.5 | PASS |  |
...
| 165 | DC2-SPINE2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.7 | PASS |  |
| 166 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.251.10 | PASS |  |
| 167 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.1 | PASS |  |
| 168 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.2 | PASS |  |
| 169 | DC2-BL1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.251.11 | PASS |  |
| 170 | DC2-BL1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.1 | PASS |  |
| 171 | DC2-BL1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.2 | PASS |  |
| 172 | DC2-LEAF1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.1 | PASS |  |
| 173 | DC2-LEAF1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.2 | PASS |  |
| 174 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.1 | PASS |  |
| 175 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.2 | PASS |  |
| 176 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.5 | PASS |  |
| 177 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.6 | PASS |  |
| 178 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.3 | PASS |  |
| 179 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.4 | PASS |  |
| 180 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.5 | PASS |  |
| 181 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.6 | PASS |  |
| 182 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.3 | PASS |  |
| 183 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 192.168.253.4 | PASS |  |
| 184 | DC2-BL1A | Routing Table | Remote Lo1 address | 192.168.254.5 | PASS |  |
| 185 | DC2-BL1A | Routing Table | Remote Lo1 address | 192.168.254.3 | PASS |  |
| 186 | DC2-BL1B | Routing Table | Remote Lo1 address | 192.168.254.5 | PASS |  |
| 187 | DC2-BL1B | Routing Table | Remote Lo1 address | 192.168.254.3 | PASS |  |
| 188 | DC2-LEAF1A | Routing Table | Remote Lo1 address | 192.168.254.5 | PASS |  |
| 189 | DC2-LEAF1A | Routing Table | Remote Lo1 address | 192.168.254.3 | PASS |  |
| 190 | DC2-LEAF1B | Routing Table | Remote Lo1 address | 192.168.254.5 | PASS |  |
| 191 | DC2-LEAF1B | Routing Table | Remote Lo1 address | 192.168.254.3 | PASS |  |
| 192 | DC2-BL1A | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 193 | DC2-BL1A | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 194 | DC2-BL1A | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 195 | DC2-BL1A | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 196 | DC2-BL1B | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 197 | DC2-BL1B | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 198 | DC2-BL1B | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 199 | DC2-BL1B | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 200 | DC2-LEAF1A | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 201 | DC2-LEAF1A | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 202 | DC2-LEAF1A | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 203 | DC2-LEAF1A | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 204 | DC2-LEAF1B | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 205 | DC2-LEAF1B | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 206 | DC2-LEAF1B | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 207 | DC2-LEAF1B | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 208 | DC2-SPINE1 | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 209 | DC2-SPINE1 | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 210 | DC2-SPINE1 | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 211 | DC2-SPINE1 | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 212 | DC2-SPINE2 | Routing Table | Remote Lo0 address | 192.168.253.5 | PASS |  |
| 213 | DC2-SPINE2 | Routing Table | Remote Lo0 address | 192.168.253.6 | PASS |  |
| 214 | DC2-SPINE2 | Routing Table | Remote Lo0 address | 192.168.253.3 | PASS |  |
| 215 | DC2-SPINE2 | Routing Table | Remote Lo0 address | 192.168.253.4 | PASS |  |
| 216 | DC2-BL1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1A - 192.168.253.5 Destination: 192.168.253.5 | PASS |  |
| 217 | DC2-BL1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1A - 192.168.253.5 Destination: 192.168.253.6 | PASS |  |
| 218 | DC2-BL1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1A - 192.168.253.5 Destination: 192.168.253.3 | PASS |  |
| 219 | DC2-BL1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1A - 192.168.253.5 Destination: 192.168.253.4 | PASS |  |
| 220 | DC2-BL1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1B - 192.168.253.6 Destination: 192.168.253.5 | PASS |  |
| 221 | DC2-BL1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1B - 192.168.253.6 Destination: 192.168.253.6 | PASS |  |
| 222 | DC2-BL1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1B - 192.168.253.6 Destination: 192.168.253.3 | PASS |  |
| 223 | DC2-BL1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-BL1B - 192.168.253.6 Destination: 192.168.253.4 | PASS |  |
| 224 | DC2-LEAF1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1A - 192.168.253.3 Destination: 192.168.253.5 | PASS |  |
| 225 | DC2-LEAF1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1A - 192.168.253.3 Destination: 192.168.253.6 | PASS |  |
| 226 | DC2-LEAF1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1A - 192.168.253.3 Destination: 192.168.253.3 | PASS |  |
| 227 | DC2-LEAF1A | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1A - 192.168.253.3 Destination: 192.168.253.4 | PASS |  |
| 228 | DC2-LEAF1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1B - 192.168.253.4 Destination: 192.168.253.5 | PASS |  |
| 229 | DC2-LEAF1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1B - 192.168.253.4 Destination: 192.168.253.6 | PASS |  |
| 230 | DC2-LEAF1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1B - 192.168.253.4 Destination: 192.168.253.3 | PASS |  |
| 231 | DC2-LEAF1B | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-LEAF1B - 192.168.253.4 Destination: 192.168.253.4 | PASS |  |
| 232 | DC2-SPINE1 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE1 - 192.168.253.1 Destination: 192.168.253.5 | PASS |  |
| 233 | DC2-SPINE1 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE1 - 192.168.253.1 Destination: 192.168.253.6 | PASS |  |
| 234 | DC2-SPINE1 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE1 - 192.168.253.1 Destination: 192.168.253.3 | PASS |  |
| 235 | DC2-SPINE1 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE1 - 192.168.253.1 Destination: 192.168.253.4 | PASS |  |
| 236 | DC2-SPINE2 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE2 - 192.168.253.2 Destination: 192.168.253.5 | PASS |  |
| 237 | DC2-SPINE2 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE2 - 192.168.253.2 Destination: 192.168.253.6 | PASS |  |
| 238 | DC2-SPINE2 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE2 - 192.168.253.2 Destination: 192.168.253.3 | PASS |  |
| 239 | DC2-SPINE2 | Loopback0 Reachability | Loopback0 Reachability | Source: DC2-SPINE2 - 192.168.253.2 Destination: 192.168.253.4 | PASS |  |

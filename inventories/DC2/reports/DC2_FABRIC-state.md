...
| 94 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet3 | PASS |  |
| 95 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet3 | PASS |  |
| 96 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1B_Ethernet3 | PASS |  |
| 97 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1B_Ethernet4 | PASS |  |
| 98 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet4 | PASS |  |
| 99 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet4 | PASS |  |
| 100 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1A_Ethernet3 | PASS |  |
| 101 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1A_Ethernet4 | PASS |  |
| 102 | DC2-L2LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - DC2-LEAF1A_Ethernet3 | PASS |  |
| 103 | DC2-L2LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - DC2-LEAF1B_Ethernet3 | PASS |  |
| 104 | DC2-LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet1 | PASS |  |
| 105 | DC2-LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet1 | PASS |  |
| 106 | DC2-LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet13 - MLAG_PEER_DC2-LEAF1B_Ethernet13 | PASS |  |
| 107 | DC2-LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet14 - MLAG_PEER_DC2-LEAF1B_Ethernet14 | PASS |  |
| 108 | DC2-LEAF1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - DC2-L2LEAF1A_Ethernet1 | PASS |  |
| 109 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet2 | PASS |  |
| 110 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet2 | PASS |  |
| 111 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet13 - MLAG_PEER_DC2-LEAF1A_Ethernet13 | PASS |  |
| 112 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet14 - MLAG_PEER_DC2-LEAF1A_Ethernet14 | PASS |  |
| 113 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - DC2-L2LEAF1A_Ethernet2 | PASS |  |
| 114 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - P2P_LINK_TO_DC2-BL1A_Ethernet1 | PASS |  |
| 115 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - P2P_LINK_TO_DC2-BL1B_Ethernet1 | PASS |  |
| 116 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-LEAF1A_Ethernet1 | PASS |  |
| 117 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet1 | PASS |  |
| 118 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - P2P_LINK_TO_DC2-BL1A_Ethernet2 | PASS |  |
| 119 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - P2P_LINK_TO_DC2-BL1B_Ethernet2 | PASS |  |
| 120 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-LEAF1A_Ethernet2 | PASS |  |
| 121 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet2 | PASS |  |
...
| 166 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 10.255.253.5 | PASS |  |
...
| 169 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.8 | PASS |  |
| 170 | DC2-BL1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 10.255.253.4 | PASS |  |
...
| 177 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.4 | PASS |  |
| 178 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.6 | PASS |  |
| 179 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 10.255.253.0 | PASS |  |
| 180 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.9 | PASS |  |
...
| 183 | DC2-SPINE1 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.5 | PASS |  |
...
| 187 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.7 | PASS |  |

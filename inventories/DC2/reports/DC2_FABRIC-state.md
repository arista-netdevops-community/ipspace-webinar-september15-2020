...
| 94 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet3 | FAIL | Interface Down - N/A |
| 96 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1B_Ethernet3 | FAIL | Interface Down - N/A |
| 97 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1B_Ethernet4 | FAIL | Interface Down - N/A |
| 100 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1A_Ethernet3 | FAIL | Interface Down - N/A |
| 101 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1A_Ethernet4 | FAIL | Interface Down - N/A |
| 109 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet1 - P2P_LINK_TO_DC2-SPINE1_Ethernet2 | FAIL | DC2-SPINE2.avd-lab.local - "Ethernet2" |
| 110 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet2 | FAIL | DC2-SPINE1.avd-lab.local - "Ethernet2" |
| 114 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - P2P_LINK_TO_DC2-BL1A_Ethernet1 | FAIL | Interface Down - N/A |
| 117 | DC2-SPINE1 | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet1 | FAIL | DC2-LEAF1B.avd-lab.local - "Ethernet2" |
| 121 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet2 | FAIL | DC2-LEAF1B.avd-lab.local - "Ethernet1" |

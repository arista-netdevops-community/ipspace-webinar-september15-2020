...
| 36 | DC2-BL1A | Interface State | Port-Channel Interface Status & Line Protocol == "up" | Port-Channel3 - MLAG_PEER_DC2-BL1B_Po3 | PASS |  |
| 37 | DC2-BL1B | Interface State | Port-Channel Interface Status & Line Protocol == "up" | Port-Channel3 - MLAG_PEER_DC2-BL1A_Po3 | PASS |  |
...
| 43 | DC2-BL1A | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | PASS |  |
| 44 | DC2-BL1A | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan4094 - MLAG_PEER | PASS |  |
| 45 | DC2-BL1B | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan4093 - MLAG_PEER_L3_PEERING | PASS |  |
...
| 79 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1B_Ethernet3 | PASS |  |
| 80 | DC2-BL1A | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1B_Ethernet4 | PASS |  |
...
| 83 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet3 - MLAG_PEER_DC2-BL1A_Ethernet3 | PASS |  |
| 84 | DC2-BL1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet4 - MLAG_PEER_DC2-BL1A_Ethernet4 | PASS |  |
...
| 93 | DC2-LEAF1B | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-SPINE2_Ethernet2 | PASS |  |
...
| 104 | DC2-SPINE2 | LLDP Topology | lldp topology - validate peer and interface | Ethernet2 - P2P_LINK_TO_DC2-LEAF1B_Ethernet2 | PASS |  |
| 105 | DC2-BL1A | MLAG | MLAG State active & Status connected | MLAG | PASS |  |
| 106 | DC2-BL1B | MLAG | MLAG State active & Status connected | MLAG | PASS |  |
...
| 116 | DC2-LEAF1B | IP Reachability | ip reachability test p2p links | Source: DC2-LEAF1B_Ethernet2 | Destination: DC2-SPINE2_Ethernet2 | PASS |  |
...
| 124 | DC2-SPINE2 | IP Reachability | ip reachability test p2p links | Source: DC2-SPINE2_Ethernet2 | Destination: DC2-LEAF1B_Ethernet2 | PASS |  |
...
| 133 | DC2-BL1A | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.5 | PASS |  |
...
| 136 | DC2-BL1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 10.255.253.4 | PASS |  |
...
| 141 | DC2-LEAF1B | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.6 | PASS |  |
...
| 150 | DC2-SPINE2 | BGP | ip bgp peer state established (ipv4) | bgp_neighbor: 172.31.252.7 | PASS |  |
...
| 153 | DC2-BL1A | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 10.255.253.5 | PASS |  |
...
| 156 | DC2-BL1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 10.255.253.4 | PASS |  |
...
| 161 | DC2-LEAF1B | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.6 | PASS |  |
...
| 170 | DC2-SPINE2 | BGP | bgp evpn peer state established (evpn) | bgp_neighbor: 172.31.252.7 | PASS |  |
